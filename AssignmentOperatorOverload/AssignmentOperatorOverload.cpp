...
public:
	...
	Contact& operator=(const Contact& object)
	{
		...
		if (this != &object)
		{
			...
			if (object.LastName != nullptr)
			{
				LastName = new char[strlen(object.LastName) + 1];
				strcpy_s(LastName, strlen(object.LastName) + 1, object.LastName);
			}
			else
			{
				LastName = nullptr;
			...
			HomePhoneNumber = object.HomePhoneNumber;
			WorkPhoneNumber = object.WorkPhoneNumber;
			PersonalPhoneNumber = object.PersonalPhoneNumber;
			Age = object.Age;
		}
		return *this;
	}
